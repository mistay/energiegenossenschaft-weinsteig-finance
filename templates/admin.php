...
<div id="weinsteigfinance-admin" class="app-weinsteigfinance">
	...
	<p><?php p($l->t('Bearbeiten Sie die Texte für die automatisierten Mahnstufen.')); ?></p>
	...
	<div id="reminder-texts-box" style="margin-bottom: 25px; max-width: 800px;">
		...
		<!-- Stage 2: Mahnung -->
		<div style="margin-bottom: 20px; border: 1px solid #ddd; padding: 15px; border-radius: 3px;">
			<h4 style="margin-top: 0; color: #333;">🟡 Stufe 2: Mahnung</h4>
			<div style="margin-bottom: 10px;">
				<label style="display: block; margin-bottom: 4px; font-weight: 500; color: #333;">Betreff:</label>
		...
		<!-- Stage 3: Letzte Mahnung -->
		<div style="margin-bottom: 20px; border: 1px solid #ddd; padding: 15px; border-radius: 3px;">
			<h4 style="margin-top: 0; color: #333;">🔴 Stufe 3: Letzte Mahnung</h4>
			<div style="margin-bottom: 10px;">
				<label style="display: block; margin-bottom: 4px; font-weight: 500; color: #333;">Betreff:</label>
				<input type="text" id="reminder-subject-3" placeholder="Letzte Mahnung" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 3px; box-sizing: border-box;">
			</div>
			<div style="margin-bottom: 10px;">
				<label style="display: block; margin-bottom: 4px; font-weight: 500; color: #333;">Nachrichtentext:</label>
				<textarea id="reminder-body-3" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 3px; box-sizing: border-box; font-family: monospace; min-height: 150px; resize: vertical;"></textarea>
				<small style="color: #666; display: block; margin-top: 4px;">Platzhalter: {name}, {address}, {amount}, {duedate}, {finaldate}</small>
			</div>
			<button class="reminder-save-btn" data-stage="3" style="padding: 8px 16px; background: #0082c9; color: white; border: none; border-radius: 3px; cursor: pointer; font-weight: 500; transition: background 0.2s;">Speichern</button>
			<span class="reminder-status" data-stage="3" style="margin-left: 10px; display: none;"></span>
		</div>
	</div>
</div>
